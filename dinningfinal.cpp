...
void chandelier()
{
	...
	glPopMatrix();
	/// <summary>
	/// here i have changed the cantilever color to black when it is a day
	/// </summary>
	/// This is an if else ....ternary opration if day=1 then color is black else color is white
	day ? glColor3f(0.0, 0.0, 0.0) : glColor3f(.2, .5, .9);
	//////////////////////////////////////////////////////////////
	int i, j;
	int dx[4] = { 2,2,-2,-2 };
	int dy[4] = { -2,2,-2,2 };
	...
	{
		////////////////////////////////////////////////////////////////
		day ? glColor3f(0.0, 0.0, 0.0): glColor3f(1, 1, 1);
		////////////////////////////////////////////////////////////////
		glPushMatrix();
		{
		...
		glPopMatrix();
		day ? glColor3f(0.0, 0.0, 0.0) : glColor3f(.7, .6, .9);
		glPushMatrix();
		{
...
void window()
{
	...
	day ? glColor3f(0,0,0):glColor3f(1, 1, 1);
...
int appleX = -100, appleY = -30, appleZ = 50;
int bananaX = -100, bananaY = -30, bananaZ = 100;
...
void fruits() {
	...
	glPushMatrix();
	{
		glTranslatef(appleX, appleY, appleZ);
...
void fruits(double x, double y, double z) {
	//Orange Fruit 
	glColor3f(0, 1,0);
	glPushMatrix();
	{
...
void display( ) {
	...
	//////////////////////////////////////
	// This above satement can be return as 
	// day == 0 ? glClearColor(BLACK, 0) : glClearColor(WHITE, 0);
	// here we are setting the background color
	/////////////////////////////////
	...
	int i;
	day ?glColor3f(0,1, 1): glColor3f(0.3, 0.3, 0.3);
	if (canDrawGrid == true)
	{
		glBegin(GL_LINES);
		{
